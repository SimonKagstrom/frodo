...
#include "IEC.h"
#if defined(COMPILE_FS)
#include "1541fs.h"
#endif
#if defined(COMPILE_D64)
#include "1541d64.h"
#endif
#if defined(COMPILE_T64)
#include "1541t64.h"
#endif
#include "Prefs.h"
#include "Display.h"
...
#endif
#if defined(COMPILE_D64)
			if (ThePrefs.DriveType[i] == DRVTYPE_D64)
				drive[i] = new D64Drive(this, ThePrefs.DrivePath[i]);
#endif
#if defined(COMPILE_T64)
			if (ThePrefs.DriveType[i] == DRVTYPE_T64)
...
#endif
#if defined(COMPILE_T64)
				if (prefs->DriveType[i] == DRVTYPE_T64)
